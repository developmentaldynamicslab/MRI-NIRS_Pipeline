...
3dclust -prefix Infants_cPL_gesConHb3/0.01/${effect}/${effect}_l1_01.nii -noabs -1thresh 7.1193 -NN1 98 GatesPLAgeSSHb_gesConHb3+tlrc"[${COUNTER}]" > Infants_cPL_gesConHb3/0.01/${effect}/${effect}_l1_01.1D
3dmerge -1clust_order 2 784 -1thresh 7.1193 -prefix Infants_cPL_gesConHb3/0.01/${effect}/clust_order_${effect}_l1_01.nii GatesPLAgeSSHb_gesConHb3+tlrc"[${COUNTER}]"
