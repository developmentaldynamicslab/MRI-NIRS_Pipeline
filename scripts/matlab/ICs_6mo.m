...
subjects={'06IND310B','06IND311B','06IND318G','06IND321G','06IND322G','06IND323G','06IND325B','06IND327G','06IND328G','06IND330B','06IND334B','06IND335B','06IND336B','06IND337G','06IND344G','06IND345B','06IND353B','06IND354B','06IND355G','06IND356G','06IND360B','06IND361B','06IND368G','06IND374B','06IND375G','06IND378G','06IND387B'}
...
eval(['load ''/Volumes/DRIVE10/India_Gates/MCs/6mo/' files '/digitization2/IND.nirs'' -mat'])
...
eval(['cd /Volumes/DRIVE10/India_Gates/MCs/6mo/' files '/digitization2/viewer/Subject']);


eval(['Data_O=importdata(''/Volumes/DRIVE10/India_Gates/NIRS/6mo/6mo_load/Worked/Final_O_' files ''');']);
eval(['Data_D=importdata(''/Volumes/DRIVE10/India_Gates/NIRS/6mo/6mo_load/Worked/Final_D_' files ''');']);
...
for j=1:size(Y,2)
    ...
    save_untouch_nii(tempHbO,['/Volumes/MAXTOR/India-gates/ICs/6mo/Load_' files '_' varName2 '_Unmasked_oxy.nii']);
    save_untouch_nii(tempHbR,['/Volumes/MAXTOR/India-gates/ICs/6mo/Load_' files '_' varName2 '_Unmasked_deoxy.nii']);
