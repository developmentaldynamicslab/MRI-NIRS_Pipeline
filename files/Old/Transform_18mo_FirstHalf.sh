...
-i ${subj} \
-o /Volumes/PegasusDDLab/IndiaY2Data/Final_Registration \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond1_Unmasked_deoxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond1_Unmasked_oxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond2_Unmasked_deoxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond2_Unmasked_oxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond3_Unmasked_deoxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond3_Unmasked_oxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond4_Unmasked_deoxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond4_Unmasked_oxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond5_Unmasked_deoxy.nii \
-w /Volumes/PegasusDDLab/IndiaY2Data/ImageReconY2/Beta_${subj}_cond5_Unmasked_oxy.nii
